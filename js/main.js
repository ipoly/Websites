...
(function() {
  ...
  $(function() {
    ...
    $("body").on("submit", "form", function() {
      ...
      t = $(this);
      inputs = t.find(":input,[atLeastOne]");
    ...
    return $("form").on("invalid", ":input,[atLeastOne]", function(e) {
      var t;
      if (e.target === this) {
        t = $(this);
        if (!this.validityMsg) {
          this.validityMsg = $('<span class="validityMsg"><span><i>&#x58;</i><strong></strong></span></span>');
          if (t.is(":checkbox,:radio")) {
            $("[name=" + t.attr("name") + "]:last").after(this.validityMsg);
          } else {
    ...
    }).on("valid", ":input,[atLeastOne]", function(e) {
      var _ref;
      if (e.target === this) {
        return (_ref = this.validityMsg) != null ? _ref.removeClass("invalid") : void 0;
      }
    });
  });
  ...
  */
  ...
  $(function() {
    ...
    return $("#questionForm").on("keyup", function(e) {
      var limit, t, txt;
      t = $(e.target);
      console.log(11);
      if (t.is("textarea")) {
